...
namespace SuperCharacters.DataAccess.Migrations
{
    ...
    [Migration("20181216225616_AddedJunctionTableManagingCharacterAndSuperPowersRelations")]
    partial class AddedJunctionTableManagingCharacterAndSuperPowersRelations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SuperCharacters.Models.SuperPowersCharacters", b =>
                {
                    b.Property<string>("CharacterId");

                    b.Property<string>("SuperPowerId");

                    b.HasKey("CharacterId", "SuperPowerId");

                    b.HasIndex("SuperPowerId");

                    b.ToTable("SuperPowersCharacters");
                });
            ...
            modelBuilder.Entity("SuperCharacters.Models.SuperPowersCharacters", b =>
                {
                    b.HasOne("SuperCharacters.Models.Character", "Character")
                        .WithMany("SuperPowersCharacters")
                        .HasForeignKey("CharacterId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("SuperCharacters.Models.SuperPower", "SuperPower")
                        .WithMany("SuperPowersCharacters")
