...
namespace SuperCharacters.DataAccess.Migrations
{
    ...
    [Migration("20181220172054_CharacterSuperPowersDeleteBehaviourSetv2.0")]
    partial class CharacterSuperPowersDeleteBehaviourSetv20
    {
            ...
            modelBuilder.Entity("SuperCharacters.Models.Score", b =>
                {
                    b.HasOne("SuperCharacters.Models.Character", "CharacterScore")
                        .WithMany()
                        .HasForeignKey("CharacterScoreId");
